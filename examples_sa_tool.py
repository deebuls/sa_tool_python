...
if __name__ == '__main__' :
    ...
    B.add_nodes_from(['h', 'h_dot', 'q_i', 'q_o'], bipartite=0, color='r', status='unknown') # Add the node attribute "bipartite"
    B.add_nodes_from(['u', 'y'], bipartite=0, color='r', status='known') # Add the node attribute "bipartite"
    B.add_nodes_from(['c1','c2','c3', 'c4', 'c5', 'c6'], bipartite=1, color='b')
